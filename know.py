...
# Wrapping the whole logic inside an app function
def app():
    ...
    if uploaded_file is not None:
        ...
        if st.button('Classify'):
            with st.spinner('Classifying the image...'):
                try:
                    # Provide the FastAPI URL here
                    fastapi_url = "http://ec2-65-2-63-247.ap-south-1.compute.amazonaws.com:8000/predict"
